...
class ATL_NO_VTABLE CTsClientPlgn :
	...
	public CComCoClass<CTsClientPlgn, &CLSID_TsClientPlgn>,
	public IDispatchImpl<ITsClientPlgn, &IID_ITsClientPlgn, &LIBID_TsTelePlgnLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
    public IWTSPlugin,
...
DECLARE_REGISTRY_RESOURCEID(IDR_TSCLIENTPLGN)


BEGIN_COM_MAP(CTsClientPlgn)
	COM_INTERFACE_ENTRY(ITsClientPlgn)
...
OBJECT_ENTRY_AUTO(__uuidof(TsClientPlgn), CTsClientPlgn)
